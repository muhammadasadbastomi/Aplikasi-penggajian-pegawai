        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('userIndex')}}">Data User</a></li>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="jabatan" name="jabatan"
                                        ...
                                        placeholder="Masukkan Jabatan" value="{{$jabatan->jabatan}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="gaji_pokok" name="gaji_pokok"
                                        ...
                                        placeholder="Masukkan Gaji Pokok" value="{{$jabatan->gaji_pokok}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="tunjangan" name="tunjangan"
                                        ...
                                        placeholder="Masukkan Tunjangan" value="{{$jabatan->tunjangan}}">
