        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Rincian & Potongan Gaji Pegawai</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">Rincian & Potongan Gaji Pegawai</h5>
            <div class="text-right">
                <a href="{{route('rincianCreate')}}" class="btn btn-sm btn-primary text-white"><i class="mdi mdi-add"></i>Tambah
                    Data</a>
            </div>
        </div>
        <!-- /.card-header -->
    ...
    <script>
        $(document).on('click', '.delete', function(e) {
            ...
            swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{ url('/admin/rincian/delete')}}" + '/' + id,
                        type: "POST",
                        data: {
                            '_method': 'DELETE',
                            "_token": "{{ csrf_token() }}"
