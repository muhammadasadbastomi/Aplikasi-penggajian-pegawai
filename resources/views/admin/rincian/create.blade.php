        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><a href="{{route('gajiIndex')}}">Rincian Gaji & Potongan Pegawai</a></li>
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">Tambah Rincian & Potongan Gaji Pegawai</h5>
                    ...
                    <div class="card card-primary">
                        ...
                        <form role="form" method="post">
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{route('rincianIndex')}}" class="btn btn-danger text-white"><i class="mdi mdi-back"></i>Batal</a>
                            </div>
                        </form>
                    </div>
                    <!-- /.card -->
