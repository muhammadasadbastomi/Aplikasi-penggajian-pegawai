...
<div class="container-fluid">
  ...
  <div class="card">
    <div class="card-header">
      <h5 class="card-title">Edit Data Periode - {{$periode->periode}}</h5>
          ...
          <div class="card card-primary">
            ...
            <form role="form" method="post">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="date" id="periode" name="periode"
                    class="form-control @error ('periode') is-invalid @enderror" placeholder="Masukkan Periode"
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="gaji_pokok" name="gaji_pokok"
                    class="form-control @error ('gaji_pokok') is-invalid @enderror" placeholder="Masukkan Gaji Pokok"
                    value="{{$periode->gaji_pokok}}">
                  @error('Gaji Pokok')<div class="invalid-feedback"> {{$message}} </div>@enderror
                </div>
                <div class="form-group">
                  <label for="tunjangan">Tunjangan</label>
                  <input type="text" id="tunjangan" name="tunjangan"
                    class="form-control @error ('tunjangan') is-invalid @enderror" placeholder="Masukkan Tunjangan"
                    value="{{$periode->tunjangan}}">
              ...
              <div class="card-footer">
                ...
                <a href="{{route('periodeIndex')}}" class="btn btn-danger text-white"><i
