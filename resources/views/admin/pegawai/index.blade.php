            ...
            <table id="example1" class="table table-bordered table-striped dataTable dtr-inline collapsed" role="grid" aria-describedby="example1_info">
              <thead>
                <tr role="row">
                  ...
                  <th class="sorting text-center" tabindex="5" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Golongan</th>
                  <th class="sorting text-center" tabindex="6" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Alamat</th>
                  <th class="sorting text-center" tabindex="7" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Tempat Lahir</th>
                  <th class="sorting text-center" tabindex="8" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Tanggal Lahir</th>
                  <th class="sorting text-center" tabindex="9" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Tanggal Masuk</th>
                  <th></th>
              </thead>
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <a class="btn btn-xs btn-info text-white" href="{{route('pegawaiEdit', ['id' => $d->uuid])}}"><i class="fas fa-edit"></i> Edit</a>
