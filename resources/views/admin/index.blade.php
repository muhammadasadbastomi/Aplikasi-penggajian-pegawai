          ...
          <div class="card-body">
            <div class="tab-content p-0">
              ...
              <div class="chart tab-pane active" id="revenue-chart" style="position: relative; height: 300px;">
                ...
                <canvas id="revenue-chart-canvas" height="600" style="height: 300px; display: block; width: 249px;" width="498" class="chartjs-render-monitor"></canvas>
              </div>
      ...
      <section class="col-lg-5 connectedSortable ui-sortable">
          ...
          <div class="card-footer bg-transparent">
            <div class="row">
              <div class="col-4 text-center">
                <div id="sparkline-1"><canvas width="160" height="100" style="width: 80px; height: 50px;"></canvas>
                </div>
                <div class="text-white">Visitors</div>
              </div>
              <!-- ./col -->
              <div class="col-4 text-center">
                <div id="sparkline-2"><canvas width="160" height="100" style="width: 80px; height: 50px;"></canvas>
                </div>
                <div class="text-white">Online</div>
              </div>
              <!-- ./col -->
              <div class="col-4 text-center">
                <div id="sparkline-3"><canvas width="160" height="100" style="width: 80px; height: 50px;"></canvas>
                </div>
        ...
        <div class="card bg-gradient-info">
          ...
          <div class="card-body">
            ...
            <canvas class="chart chartjs-render-monitor" id="line-chart" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 249px;" width="498" height="500"></canvas>
          </div>
          <!-- /.card-body -->
          <div class="card-footer bg-transparent">
            <div class="row">
                    ...
                    <div class="datepicker">
                      <div class="datepicker-days" style="">
                        <table class="table table-sm">
                          ...
                          <tbody>
                            <tr>
                              <td data-action="selectDay" data-day="03/29/2020" class="day old weekend">29</td>
                            ...
                            <tr>
                              ...
                              <td data-action="selectDay" data-day="04/11/2020" class="day weekend">11</td>
                            </tr>
                            <tr>
                              <td data-action="selectDay" data-day="04/12/2020" class="day weekend">12</td>
                              ...
                              <td data-action="selectDay" data-day="04/18/2020" class="day weekend">18</td>
                            </tr>
                            <tr>
                              <td data-action="selectDay" data-day="04/19/2020" class="day weekend">19</td>
                              ...
                              <td data-action="selectDay" data-day="04/24/2020" class="day active today">24</td>
                              <td data-action="selectDay" data-day="04/25/2020" class="day weekend">25</td>
                            </tr>
                            <tr>
                              <td data-action="selectDay" data-day="04/26/2020" class="day weekend">26</td>
                              ...
                              <td data-action="selectDay" data-day="05/02/2020" class="day new weekend">2</td>
                            </tr>
                            <tr>
                              <td data-action="selectDay" data-day="05/03/2020" class="day new weekend">3</td>
                              ...
                              <td data-action="selectDay" data-day="05/09/2020" class="day new weekend">9</td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
                        ...
                        <table class="table-condensed">
                          <thead>
                            <tr>
                              ...
                              <th class="picker-switch" data-action="pickerSwitch" colspan="5" title="Select Year">2020
                              </th>
