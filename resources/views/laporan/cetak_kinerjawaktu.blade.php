...
<head>
    ...
    <title>Laporan Kinerja Ketepatan Waktu Pegawai Kontrak</title>
...
<body>
    ...
    <div class="container">
        <h2 style="text-align:center; margin-top:-25px;">Laporan Data Kinerja Ketepatan Waktu Periode {{\carbon\carbon::parse($start)->translatedFormat('d F Y')}} - {{\carbon\carbon::parse($end)->translatedFormat('d F Y')}}</h2>
