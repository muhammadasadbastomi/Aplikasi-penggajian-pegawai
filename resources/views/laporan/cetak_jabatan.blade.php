...
<body>
    ...
    <h5 class="sorting text-center">Laporan Data Jabatan Pegawai Dinas Perhubungan Kota Banjarbaru</h5>
    <h6 class="sorting text-center"><a style="margin-top: 12px; color: black;">Laporan Data Jabatan Pegawai</a>
    </h6>
    <br>
